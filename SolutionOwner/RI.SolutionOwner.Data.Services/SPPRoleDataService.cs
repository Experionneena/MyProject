//-----------------------------------------------------
// <copyright file="SPPRoleDataService.cs" company="RechargeIndia">
...
namespace RI.SolutionOwner.Data.Services
{
    ...
    /// </summary>
    public class SPPRoleDataService : BaseDataService, ISPPRoleDataService
    {
        ...
        /// ISPPRole Repository
        /// </summary>
        private IRepository<ISPPRole> roles;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SPPRoleDataService" /> class.
        /// </summary>
        /// <param name="unitOfWork">Unit Of Work</param>
        /// <param name="logger">The Logger</param>
        public SPPRoleDataService(IUnitOfWork unitOfWork, ILoggerExtension logger) : base(unitOfWork)
        {
            roles = UnitOfWork.Repository<ISPPRole>();
            this.logger = logger;
        }
        ...
        /// boolean value
        /// </returns>
        public async Task<bool> EditRole(ISPPRole role)
        {
            try
            {
                bool exists = false;

                var roleList = new List<ISPPRole>(await roles.GetAllAsync());
                if (roleList.Count() > 1)
                {
                ...
                if (!exists)
                {
                    ...
                    roleEntity.SPPRolePermissions = role.SPPRolePermissions;
