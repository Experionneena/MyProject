//----------------------------------------------------------
// <copyright file="SPPRoleFeatureDataService.cs" company="RechargeIndia">
...
namespace RI.SolutionOwner.Data.Services
{
    ...
    /// </summary>
    public class SPPRoleFeatureDataService : BaseDataService, ISPPRoleFeatureDataService
    {
        ...
        /// </summary>
        private IRepository<ISPPRolePermission> sproleFeature;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SPPRoleFeatureDataService"/> class.
        /// </summary>
        /// <param name="unitOfWork">The unit of work.</param>
        /// <param name="logger">The logger.</param>
        public SPPRoleFeatureDataService(IUnitOfWork unitOfWork, ILoggerExtension logger) : base(unitOfWork)
        {
            sproleFeature = UnitOfWork.Repository<ISPPRolePermission>();
            this.logger = logger;
        }
        ...
        public List<ISPPRolePermission> GetRolesForFeatureId(int featureId)
        {
