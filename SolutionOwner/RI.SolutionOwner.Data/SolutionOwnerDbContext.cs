...
namespace RI.SolutionOwner.Data
{
    ...
    public class SolutionOwnerDbContext : DbContext
    {
        ...
        public DbSet<SPPRole> SPPRole { get; set; }

        public DbSet<SPPRolePermission> SPPRolePermission { get; set; }

        public DbSet<SPPUser> SPPUser { get; set; }

        public DbSet<SPPUserRole> SPPUserRole { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new SPPRolePermissionMap());
            modelBuilder.Configurations.Add(new SPPRoleMap()); ;
            modelBuilder.Configurations.Add(new SPPUserMap());
            modelBuilder.Configurations.Add(new SPPUserRoleMap());
