//-----------------------------------------------------
// <copyright file="SPPRolePermission.cs" company="RechargeIndia">
...
namespace RI.SolutionOwner.Data.Entities
{
    ...
    /// </summary>
    public class SPPRolePermission : BaseEntity, ISPPRolePermission
    {
        /// <summary>
        ...
        /// The roles.
        /// </value>
        public virtual SPPRole Roles { get; set; }
        ...
        /// The features.
        /// </value>
        public virtual SPFeature Features { get; set; }
    }
}
