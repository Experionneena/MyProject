//-----------------------------------------------------
// <copyright file="SPPRoleMap.cs" company="RechargeIndia">
...
namespace RI.SolutionOwner.Data.Mapping
{
    ...
    /// SP Role Map class
    /// </summary>
    public class SPPRoleMap : EntityTypeConfiguration<SPPRole>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SPPRoleMap"/> class.
        /// </summary>
        public SPPRoleMap()
        {
            // Primary Key
            ...
            this.HasRequired(t => t.Hierarchy)
              .WithMany(x => x.PartnerPortalRole)
