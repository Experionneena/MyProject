//----------------------------------------------------------------
// <copyright file="SORolePermissionMap.cs" company="RechargeIndia">
...
namespace RI.SolutionOwner.Data.Mapping
{
    ...
    /// </summary>
    public class SORolePermissionMap : EntityTypeConfiguration<SORolePermission>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SORolePermissionMap"/> class.
        /// </summary>
        public SORolePermissionMap()
        {
            this.HasKey(x => x.Id);
            ...
            this.ToTable("SORolePermissions");
        }
    }
}
