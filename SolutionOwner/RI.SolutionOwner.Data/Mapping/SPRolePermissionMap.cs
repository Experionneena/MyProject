//-----------------------------------------------------
// <copyright file="SPRolePermissionMap.cs" company="RechargeIndia">
...
namespace RI.SolutionOwner.Data.Mapping
{
    ...
    /// </summary>
    public class SPRolePermissionMap : EntityTypeConfiguration<SPRolePermission>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SPRolePermissionMap"/> class.
        /// </summary>
        public SPRolePermissionMap()
        {
            this.HasKey(x => x.Id);
            ...
            this.ToTable("SPRolePermissions");
        }
    }
}
