//----------------------------------------------------------
// <copyright file="SPPRoleHierarchyController.cs" company="RechargeIndia">
...
namespace RI.SolutionOwner.WebAPI.Controllers
{
    ...
    /// </summary>
    public class SPPRoleHierarchyController : BaseController
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SPPRoleHierarchyController"/> class.
        /// </summary>
        ...
        public SPPRoleHierarchyController(
        ...
        [HttpGet]
        [Route("SPPRoleHierarchy/GetRoleByHierarchy/{hierarchyId}")]
        public HttpResponseMessage GetRoleByHierarchy([FromUri] int hierarchyId)
        {
            try
            {
                ...
                return CreateHttpResponse<IEnumerable<ISPPRole>>(
                    HttpStatusCode.OK, HttpCustomStatus.Success, roles, "Success.");
            }
            catch (Exception ex)
            {
                logger.Error(ex.Message);
                return CreateHttpResponse<ISPPRole>(HttpStatusCode.ExpectationFailed, HttpCustomStatus.Failure, null, "Web Service Error: Please report this problem or try again later.");
            }
        }
