...
namespace RI.SolutionOwner.WebAPI.Controllers
{
    ...
    public class SPCategoryController : BaseController
    {
        ...
        /// <returns>HttpResponse Message</returns>
        [HttpGet]
        [Route("SPCategory/GetAllCategories")]
        ...
        /// <returns>HttpResponse Message</returns>
        [HttpDelete]
        [Route("SPCategory/DeleteCategory/{id}")]
        ...
        /// <returns>HttpResponse Message</returns>
        [HttpGet]
        [Route("SPCategory/GetCategoryById/{id}")]
        ...
        /// <returns>HttpResponse Message</returns>
        [HttpPut]
        [Route("SPCategory/UpdateCategory")]
