...
namespace RI.SolutionOwner.WebAPI.Ingest.Controllers
{
    ...
    public class SOSolutionPartnerContactController : BaseController
    {
        ...
        [HttpGet]
        [Route("SOSolutionPartnerContact/GetSolutionPartnerContactBySPId/{SOSPId}/{dummyId}")]
        ...
        /// <returns>The Http response message.</returns>
        [HttpGet]
        [Route("SOSolutionPartnerContact/GetSolutionPartnerContactById/{id}")]
        ...
        /// <returns></returns>
        [HttpPost]
        [Route("SOSolutionPartnerContact/CreateSolutionPartnerContact")]
        ...
        /// <returns></returns>
        [HttpPut]
        [Route("SOSolutionPartnerContact/EditSolutionPartnerContact")]
        ...
        /// <returns></returns>
        [HttpDelete]
        [Route("SOSolutionPartnerContact/DeleteSolutionPartnerContact/{id}")]
