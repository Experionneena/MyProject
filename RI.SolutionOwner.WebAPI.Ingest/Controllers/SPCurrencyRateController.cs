...
namespace RI.SolutionOwner.WebAPI.Ingest.Controllers
{
    ...
    public class SPCurrencyRateController : BaseController
    {
        ...
        [HttpPost]
        [Route("SPCurrencyRate/CreateCurrencyDescription")]
        ...
        /// <returns>Http Response Message</returns>
        [HttpGet]
        [Route("SPCurrencyRate/GetAllCurrencyRate")]
        ...
        /// <returns>Http Response Message</returns>
        [HttpGet]
        [Route("SPCurrencyRate/GetCurrency/{id}")]
        ...
        /// <returns>Http Response Message</returns>
        [HttpPut]
        [Route("SPCurrencyRate/UpdateCurrency")]
        ...
        /// <returns>Http Response Message</returns>
        [HttpDelete]
        [Route("SPCurrencyRate/DeleteCurrency/{id}")]
        ...
        /// <returns>Http Response Message</returns>
        [HttpPut]
        [Route("SPCurrencyRate/ActivateDeactivateCurrencyRate")]
        public async Task<HttpResponseMessage> ActivateDeactivateCurrencyRate([FromUri] int id, [FromUri] int flag)
        {
            try
            {
                if (flag == 1)
                {
                    ...
                    if (!result)
                    {
                        return CreateHttpResponse<bool>(HttpStatusCode.Accepted, HttpCustomStatus.Failure, result, "Already in activated state.");
                    }
                ...
                if (flag == 0)
                {
                    ...
                    if (!result)
                    {
                        return CreateHttpResponse<bool>(HttpStatusCode.Accepted, HttpCustomStatus.Failure, result, "Already in deactivated state");
                    }
