...
namespace RI.SolutionOwner.WebAPI.Ingest.Controllers
{
    ...
    public class SOFeatureController : BaseController
    {
        ...
        [HttpGet]
        [Route("SOFeature/GetAllFeatures")]
        ...
        /// <returns>HttpResponseMessage object</returns>
        [HttpGet]
        [Route("SOFeature/GetFeatureById/{id}")]
        ...
        /// <returns>HttpResponseMessage object</returns>
        [HttpDelete]
        [Route("SOFeature/DeleteFeature/{id}")]
        ...
        /// <returns>HttpResponseMessage object</returns>
        [HttpGet]
        [Route("SOFeature/ActivateDeactivateFeature/{id}/{flag}")]
