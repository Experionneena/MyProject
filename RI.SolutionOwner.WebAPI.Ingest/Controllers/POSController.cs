...
namespace RI.SolutionOwner.WebAPI.Ingest.Controllers
{
    ...
    public class POSController : BaseController
    {
        ...
        /// <returns>HttpResponseMessage object</returns>
        [HttpGet]
        [Route("POS/GetPOSParameterById/{parameterId}")]
        ...
        /// <returns>HttpResponseMessage object</returns>
        [HttpDelete]
        [Route("POS/DeletePOSParameter/{parameterId}")]
        ...
        /// <returns>HttpResponseMessage object</returns>
        [HttpPut]
        [Route("POS/ChangePOSParameterStatus/paramId/{parameterId}/activeId/{flag}")]
