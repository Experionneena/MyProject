...
namespace RI.SolutionOwner.WebAPI.Controllers
{
    ...
    public class SPFeatureController : BaseController
    {
        ...
        [HttpGet]
        [Route("SPFeature/GetAllFeatures")]
        ...
        /// <returns>Http Response Message</returns>
        [HttpGet]
        [Route("SPFeature/GetFeatureById/{id}")]
        ...
        /// <returns>Http Response Message</returns>
        [HttpDelete]
        [Route("SPFeature/DeleteFeature/{id}")]
        ...
        /// <returns>Http Response Message</returns>
        [HttpGet]
        [Route("SPFeature/ActivateDeactivateFeature/{id}/{flag}")]
