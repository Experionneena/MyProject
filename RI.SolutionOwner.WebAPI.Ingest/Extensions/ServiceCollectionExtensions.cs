...
namespace RI.SolutionOwner.WebAPI.Ingest.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddDataLayer(this IServiceCollection services)
        {
            ...
            string dataassemblyPath = executablePath + "/" + dataAssemblyName;
        ...
        public static void AddBusinessServiceLayer(this IServiceCollection services)
        {
            ...
            string executablePath = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            string businessassemblyPath = executablePath + "/" + businessAssemblyName;
        ...
        public static void AddDataServiceLayer(this IServiceCollection services)
        {
            ...
            string executablePath = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
            string dataAccessAssemblyPath = executablePath + "/" + dataServiceAssemblyName;
